...
import { PlayCircleIcon, BrainIcon, BarChartIcon, EyeIcon, SunIcon, MoonIcon } from '../../assets/icons/Icons'
...
export default function LoginPage() {
  ...
  const SLIDES = [
    { Icon: PlayCircleIcon, title: t('slide1_title'), desc: t('slide1_desc') },
    { Icon: BrainIcon, title: t('slide2_title'), desc: t('slide2_desc') },
    { Icon: BarChartIcon, title: t('slide3_title'), desc: t('slide3_desc') },
  ]
  ...
  return (
    ...
    >
        ...
        >
          ...
          <form onSubmit={submit}>
            <div style={{ marginBottom: 18 }}>
              ...
              >
                {t('signin_phone_label')}
              </label>
              <input
                value={identifier}
                onChange={(e) => setIdentifier(e.target.value)}
                placeholder="e.g. +7 777 123 4567 or name@mail.com"
                required
            ...
            >
              {loading ? t('signin_loading') : t('signin_btn')}
            </motion.button>
          </form>
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 80, height: 80, borderRadius: 28, background: 'rgba(255,255,255,0.15)', margin: '0 auto 16px' }}>
            {(() => { const S = SLIDES[slide]; return <S.Icon size={38} color="white" /> })()}
          </div>
